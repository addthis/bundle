...
public class ValueTranslationException extends RuntimeException {
    ...
    public ValueTranslationException(String message, Throwable cause) {
        super(message, cause);
    }

    public ValueTranslationException(String message) {
        super(message);
    }

    public ValueTranslationException(Throwable cause) {
        super(cause);
    }
}
